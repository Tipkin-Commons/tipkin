...
<div style="width: 500px;">
	<div class="col_12 visible center" style="">
		<br />
		<form method="post" style="display: inline;" enctype="multipart/form-data" id="form-change-avatar" action="/profile-pro/photo">
			<label>Votre photo de profil actuelle :</label>
			<br /><br />
			<img alt="image de profil" src="{$avatar}" class="avatar">
			<br /><br />
			...
			<div id="ajax-loading" style="display: none;">
				...
				<br/>
				<img alt="chargement..." src="/images/ajax-loader.gif"/>
				<br />
			</div>
		</form>
